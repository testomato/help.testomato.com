...
[Testomato](https://testomato.com) is sensitive to **Common Server Error Messages**. They are a marker for us to indicate that something is broken on your website.
...
We have a page that shows randomly generated examples of some of the most common error messages: https://testomato.com/example/error
